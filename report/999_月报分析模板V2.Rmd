...
```{r}
totalnewcars <- caculate_carsmean(jdnews,"level")
totalpreviouscars <- caculate_carsmean(jdpreviouss,"level")
x <- caculate_increaseratio(totalnewcars,totalpreviouscars)
totallastcars <- caculate_carsmean(jdlasts,"level")
...
```{r}
totalnewpasscars <- caculate_passcarsmean(jdnews,"level")
totalpreviouspasscars <- caculate_passcarsmean(jdpreviouss,"level")
x <- caculate_increaseratio(totalnewpasscars,totalpreviouspasscars)
totallastpasscars <- caculate_passcarsmean(jdlasts,"level")
...
```{r}
totalnewfrecars <- caculate_frecarsmean(jdenws,"level")
totalpreviousfrecars <- caculate_frecarsmean(jdpreviouss,"level")
x <- caculate_increaseratio(totalnewfrecars,totalpreviousfrecars)
totallastfrecars <- caculate_frecarsmean(jdenws,"level")
