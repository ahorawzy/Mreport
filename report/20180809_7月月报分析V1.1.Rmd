...
```{r}
airportnew <- caculate_frecarsmean(jdnews,attsname = "airport")
airportprevious <- caculate_frecarsmean(jdpreviouss,attsname = "airport")
x1 <- caculate_increaseratio(airportnew,airportprevious)
airportlast <- caculate_frecarsmean(jdlasts,attsname = "airport")
